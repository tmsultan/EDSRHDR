...
# python main.py --model EDSR --scale 2 --patch_size 96 --save edsr_baseline_x2 --reset --cpu
...
# RDN BI model (x3)
#python3.6 main.py --scale 3 --save RDN_D16C8G64_BIx3 --model RDN --epoch name 'net' is not defined
# 200 --batch_size 16 --data_range 801-805 --patch_size 96 --reset
# RDN BI model (x4)
